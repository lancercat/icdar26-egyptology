...
if __name__ == '__main__':
    ...
    tome = arm_egptology_v3R_task_grp(pcfg, tome,tie_weight=True);
    ...
    ars={};
    for iterk in ITRS:
        logpath = os.path.join("/home/lasercat/writebuffer/tmp/hydra_results/", curname+iterk);
    ...
    torch.save(ars,os.path.join("/home/lasercat/writebuffer/tmp/hydra_results/", curname+".pt"));