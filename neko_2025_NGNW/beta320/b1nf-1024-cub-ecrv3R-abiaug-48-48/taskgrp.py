...
from neko_2025_NGNW.common.object_32x_presets.tasks.taskgrps.cub200 import arm_cub200_task_grp

def arm_taskgrp(pcfg,tome):
    # tome=arm_ctwch_task_grp(pcfg,tome,True);
    tome = arm_egptology_v3R_task_grp(pcfg, tome,"abinet");
    tome=arm_cub200_task_grp(pcfg,tome,False);
